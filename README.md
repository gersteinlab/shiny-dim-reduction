...
There are four ways to use this project:

* <b>Online App:</b> If you received a URL, no installations are necessary and you can use the application at the provided link.
* <b>Portable App:</b> If you received a portable Windows application generated by this project, no installations are necessary. To run the application, unzip the directory and execute "run.bat". 7Zip is recommended for unzipping.
