...
test_that("is_color_scale() works", {
  is_color_scale(NULL) %>% expect_false()
  is_color_scale(NaN) %>% expect_false()
  character() %>% is_color_scale() %>% expect_true()
  "" %>% is_color_scale() %>% expect_false()
  "#######" %>% is_color_scale() %>% expect_false()
  "#BCDEFG" %>% is_color_scale() %>% expect_false()
  "ABCDEF" %>% is_color_scale() %>% expect_false()
  "ABCDEFF" %>% is_color_scale() %>% expect_false()
  "ABCDEFFF" %>% is_color_scale() %>% expect_false()
  "#ABCDEF" %>% is_color_scale() %>% expect_true()
  "#ABCDEG" %>% is_color_scale() %>% expect_false()
  "#ABCDEFF" %>% is_color_scale() %>% expect_false()
  "#ABCDEFFF" %>% is_color_scale() %>% expect_true()
  "#ABCDEFFG" %>% is_color_scale() %>% expect_false()
})
