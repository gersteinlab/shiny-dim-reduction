...
combined_miRNA <- convert_to_num(miRNA %>% as.matrix())
combined_piRNA <- convert_to_num(piRNA %>% as.matrix())
combined_tRNA <- convert_to_num(tRNA %>% as.matrix())
combined_circRNA <- convert_to_num(circRNA %>% as.matrix())
combined_ex_miRNA <- convert_to_num(ex_miRNA %>% as.matrix())
combined_cumulative_ex_genomes <- convert_to_num(cumulative_ex_genomes %>% as.matrix())
...
combined_Gene_Total <- convert_to_num(all_gene_clean %>% as.matrix())
...
saveRDS(cumulative_ex_genomes , "combined/combined_cumulative_ex_genomes.rds")
saveRDS(specific_ex_genomes , "combined/combined_specific_ex_genomes.rds")
saveRDS(cumulative_ex_ribosomes , "combined/combined_cumulative_ex_ribosomes.rds")
saveRDS(specific_ex_ribosomes  , "combined/combined_specific_ex_ribosomes.rds")
